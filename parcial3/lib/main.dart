  ...
  Future<List<StarsWars>> _getStarsWars() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var item in jsonData["results"]) {
        lista.add(StarsWars(item["name"], item["diameter"], item["population"], item["climate"],
                                item["url"], "https://starwars-visualguide.com/assets/img/planets/"+item["url"].replaceAll(new RegExp(r'[^0-9]'),'')+".jpg"));
      ...
      throw Exception("Error en conexion");
    }
    return lista;
  }
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        child: Row(
          ...
          children: [
           Icon(FeatherIcons.arrowLeft, color: Colors.black,),
            Text('STARS WARS', style: TextStyle(
              color: Colors.black
            ),),
